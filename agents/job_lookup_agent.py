...
def lookup(name: str) -> str:
    ...
    tools_for_agent = [
        Tool(
            name="Crawl Google for list of jobs",
            func=scrape_job_profile,
            description="Useful for when you need to get a list of jobs.",
        )
    ]
...
if __name__ == "__main__":
    job_role = "Remote  Senior Software Engineer jobs in Canada"
    job_urls = lookup(name=job_role)
    print(job_urls)
